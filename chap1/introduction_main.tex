...
\begin{enumerate}
    ...
    \item To test the vehicle's ability to navigate a course autonomously, measuring success based on lane-keeping accuracy and smoothness of motion, and comparing these metrics against the original human training data.
\end{enumerate}
