...
\supervisor{Asst Prof. Renato V. Crisostomo, MSCS}                 % your supervisor(s) name - no . in Dr
...
\doctype{undergraduate thesis proposal}                      % the type of document (fyp, dissertation, thesis)
\degreedate{Jan, 2026 }                             % when did you submit -- officially after your corrections !
...
\mainmatter 
    ...
    \appendix
        \input{appA/appendix_a_main}     % these are just test names as I didn't know what you'd
        \input{appB/appendix_b_main}
{\backmatter
    % Bibliography
    \if@openright\cleardoublepage\else\clearpage\fi
    \bibliographystyle{um-plainnat} %% specific plainnat does not show url for articles
    {\footnotesize\bibliography{chap1/introduction_biblio,chap2/lit_overview_biblio}}
	\printindex
}
